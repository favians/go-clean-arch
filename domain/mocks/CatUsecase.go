...
func (_m *CatUsecase) GetOne(ctx context.Context, id string) (*domain.Cat, error) {
...
func (_m *CatUsecase) Store(ctx context.Context, u *domain.Cat) (*domain.Cat, error) {
	ret := _m.Called(ctx, u)
...
func (_m *CatUsecase) Update(ctx context.Context, cat *domain.Cat, id string) (*domain.Cat, error) {
